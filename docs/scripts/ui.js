...
`);var D=new CSSStyleSheet,ne=()=>D.replaceSync(`/* 
...
`);var $=new CSSStyleSheet,ie=()=>$.replaceSync("");var I=new CSSStyleSheet,de=()=>I.replaceSync(`/* 
Usage:
...
`);var N=new CSSStyleSheet,se=()=>N.replaceSync(`.card {
  /* Settings */
...
`);var B=new CSSStyleSheet,X=()=>{let e="var(--token-color-background, black)",o="var(--token-color-background-hue)",a="var(--token-color-background-saturation)",t="var(--token-color-background-lightness)",i=`
  .dashboard {
...
}`;return B.replaceSync(`${i}${s}${n}`)};var R=new CSSStyleSheet,ce=()=>R.replaceSync(`:root {
...
`);var U=new CSSStyleSheet,be=()=>{let e=`
  .dropdown {
...
`)};var j=new CSSStyleSheet,ge=()=>j.replaceSync(`.flexgrid {
  --mobile-gap: 10px;
  --tablet-gap: 20px;
  --desktop-gap: 30px;
  --mobile-width: 200px;
...
`);var G=new CSSStyleSheet,pe=()=>G.replaceSync(`:root {
...
/* States */
.flexpane--loading {}
.flexpane--disabled {}`);var W=new CSSStyleSheet,he=()=>W.replaceSync(`.grid {
...
`);var V=new CSSStyleSheet,ve=()=>V.replaceSync(`.section {
}
...
`);var K=new CSSStyleSheet,ue=()=>K.replaceSync(`.toggle {
  position: relative;
  width: 50px;
  height: 50px;
  background-color: var(--bg-color);
...
}`;L.replaceSync(s)};var J=new CSSStyleSheet,me=()=>J.replaceSync(`.tooltip {
  cursor: pointer;
  position: relative;
}
...
`;return o}var u=new JSZip,k=e=>{switch(e.action){case"DISABLE_TOKENS":S.set(!1),M();break;case"DOWNLOAD_ALL":u.file("tokens.css",p(L)),u.file("accordion.css",p(O)),u.file("alerts.css",p(D)),u.file("badge.css",p(P)),u.file("bg.css",p($)),u.file("button.css",p(I)),u.file("card.css",p(N)),u.file("dashboard.css",p(B)),u.file("dialog.css",p(R)),u.file("dropdown.css",p(U)),u.file("flexgrid.css",p(j)),u.file("flexpane.css",p(G)),u.file("grid.css",p(W)),u.file("section.css",p(V)),u.file("toggles.css",p(K)),u.file("tooltip.css",p(J)),u.generateAsync({type:"blob"}).then(a=>{let t=document.createElement("a");t.href=URL.createObjectURL(a),t.download="capui.zip",t.click()});break;case"DOWNLOAD_THEME_TOKENS":let o=document.createElement("a");o.href=URL.createObjectURL(new Blob([p(L)],{type:"text/css"})),o.download="tokens.css",o.click();break;case"ENABLE_TOKENS":S.set(!0),M();break;case"SET_PAGE":f.set(e.page),window.history.pushState(null,"",`?page=${e.page}`);break;case"SET_PROPERTIES":C.set(e.properties);break;case"SET_COLOR_PICKER":C.set("COLOR_PICKER"),T.set(e.colorKey);break;case"SET_COLOR_TOKEN":w.deepSet(`${e.theme}.colors.${e.key}`,[e.color,e.contrast]),M();break;case"SET_THEME":y.set(e.theme),M();break}};function He(){return(e,o)=>fetch(o).then(a=>a.text()).then(a=>e.innerHTML=a)}var r=ee({"attr:tokensEnabled":q({state:S}),"click:tokensEnabled":H({event:"click",state:S}),"innerHTML:colorPicker":E({state:T}),"innerHTML:pages":E({state:f}),"innerHTML:properties":E({state:C}),"innerHTML:themes":E({state:w}),"innerHTML:theme":E({state:y}),"innerText:pages":Q({state:f}),"style:themes":Z({state:w}),"svg:load":He(),"text:tokensEnabled":Q({state:S}),attr:q(),change:H({event:"change"}),class:oe(),click:H({event:"click"}),innerHTML:E(),input:H({event:"input"}),style:Z()});var fe=()=>r.div()("button");var ye=()=>{let e=()=>T.get(),o=()=>y.get(),a=()=>w.get()[o()].colors[e()][0],t=()=>w.get()[o()].colors[e()][1];return r.div(["innerHTML:colorPicker",()=>[r.div()(T.get()),r.div(["style","opacity","0.35"],["style","fontSize","0.8em"])("Set the color and it's contrast"),r.div(["style","fontSize","0.85em"],["style","opacity",.6])("Color"),r.div(["style","boxShadow","1px 0px 20px -2px rgba(0,0,0,0.5)"],["style","borderRadius","5px"],["style","width",`${150-20}px`],["style","height",`${80-20}px`],["style","overflow","hidden"],["style","position","relative"])(r.input(["style","position","absolute"],["style","top",`-${20/2}px`],["style","left",`-${20/2}px`],["attr","type","color"],["style","width",`${150}px`],["style","height",`${80}px`],["style","backgroundColor","transparent"],["input",n=>{console.log(n.target.value),k({action:"SET_COLOR_TOKEN",key:T.get(),theme:y.get(),color:n.target.value,contrast:t()})}],["attr","value",a()])()),r.div(["style","fontSize","0.85em"],["style","opacity",.6])("Contrast"),r.div(["style","boxShadow","1px 0px 20px -2px rgba(0,0,0,0.5)"],["style","borderRadius","5px"],["style","width",`${150-20}px`],["style","height",`${80-20}px`],["style","overflow","hidden"],["style","position","relative"])(r.input(["style","position","absolute"],["style","top",`-${20/2}px`],["style","left",`-${20/2}px`],["attr","type","color"],["style","width",`${150}px`],["style","height",`${80}px`],["style","backgroundColor","transparent"],["input",n=>{k({action:"SET_COLOR_TOKEN",key:T.get(),theme:y.get(),color:a(),contrast:n.target.value})}],["attr","value",t()])()),r.div(["style","fontSize","0.85em"],["style","opacity",.6])("Token"),r.div(["style","whiteSpace","nowrap"],["style","fontSize","0.8em"],["style","opacity","0.35"])(`--token-${e()}`)]],["style","display","flex"],["style","flexDirection","column"],["style","gap","20px"])()};var Ae=e=>{let o=`--token-color-${e}-contrast-hue`,a=`--token-color-${e}-contrast-saturation`,t=`--token-color-${e}-contrast-lightness`,l=`hsla(var(${o}), var(${a}), var(${t}),0.1)`;return r.div(["class","flexgrid__item"])(r.div(["class","card"],["class","card--small"],["class","card--light"],["class","card--ghost"],["style","--card-bg-color",`var(--token-color-${e})`],["style","--card-outer-border-color",l],["style","--card-transition-duration",0],["click",()=>k({action:"SET_COLOR_PICKER",colorKey:e})],["style","cursor","pointer"])(r.div(["class","card__title"],["style","--card-text-color",`var(--token-color-${e}-contrast)`])(e),r.div(["class","card__actions"])(r.div(["class","gg-chevron-right"],["style","color",`var(--token-color-${e}-contrast)`])()),r.div(["class","card__body"],["style","display","flex"],["style","columnGap","1%"],["style","rowGap","5px"],["style","flexWrap","wrap"],["style","alignItems","center"],["style","position","relative"],["style","alignItems","flex-start"],["style","justifyContent","flex-start"])(r.div(["style","borderRadius","2px"],["style","display","flex"],["style","flexDirection","column"],["style","height","20px"],["style","width","10%"],["style","backgroundColor",`var(--token-color-${e}-contrast)`])())))},we=()=>{let e=w.get()[y.get()].colors;return r.div(["style","display","flex"],["style","flexDirection","column"],["style","gap","20px"],["style","padding","20px"],["style","borderRadius","10px"])(r.section(["class","section"],["style","display","flex"],["style","flexDirection","column"],["style","gap","20px"])(r.div(["class","section__header"])(r.h2(["class","section__header__title"])("Colors"),r.p(["class","section__header__description"])("Colors are defined along with a contasting color to form a set of semantic primitives which can be further modified in context (per component) through the use of CSS variables.")),r.h3(["class","section__subheader__title"])("Primitives"),r.div(["class","flexgrid"],["style","--mobile-width","80px"],["style","--tablet-width","100px"],["style","--desktop-width","100px"],["style","--mobile-gap","20px"],["style","--tablet-gap","20px"],["style","--desktop-gap","20px"],["innerHTML:theme",()=>Object.keys(e).map(Ae)])()),r.section()(r.h2()("Fonts")))};var ze=e=>r.option(["attr","selected",!0,()=>y.get()===e])(e),te=()=>r.div(["style","display","flex"],["style","flexDirection","row"],["style","gap","10px"],["style","justifyContent","space-between"],["style","alignItems","center"],["style","width","100%"])(r.div(["style","display","flex"],["style","gap","20px"],["style","alignItems","center"],["style","justifyContent","center"],["style","flex",1])(r.select(["class","dropdown"],["class","dropdown--small"],["attr:tokensEnabled","disabled",()=>!S.get()],["change",e=>{let o=e.target.value;k({action:"SET_THEME",theme:o})}])(...Object.keys(w.get()).map(ze))),r.div(["style","display","flex"],["style","gap","10px"],["style","alignItems","center"],["style","justifyContent","center"])(r.button(["class","button"],["class","button--small"],["class","button--light"],["class","button--outline"],["style","gap","10px"],["class","button--justify-start"],["class","tooltip"],["attr","aria-label","Download current theme tokens"],["click",()=>k({action:"DOWNLOAD_THEME_TOKENS"})])(r.span()("tokens.css"),r.span()("[\u2193]")),r.button(["class","button"],["class","button--light"],["class","button--outline"],["class","button--small"],["style","gap","10px"],["class","button--justify-start"],["class","tooltip"],["attr","aria-label","Download current theme tokens"],["click",()=>S.get()?k({action:"DISABLE_TOKENS"}):k({action:"ENABLE_TOKENS"})],["text:tokensEnabled","Disable Tokens",e=>e],["text:tokensEnabled","Enable Tokens",e=>!e])()));var Oe=r.div(["class","dashboard__nav-header"])(r.img(["attr","src","/images/capui-transparent.png"],["attr","height","80"])()),_=[["class","button"],["class","button--light"],["class","button--ghost"],["class","button--block"],["class","button--justify-start"]],De=r.nav(["class","dashboard__nav"])(r.div(["style","display","flex"],["style","flexDirection","column"],["style","gap","3px"],["style","alignItems","flex-start"],["style","width","100%"])(r.button(["class","button"],["class","button--light"],["class","button--block"],["style","marginBottom","10px"],["style","gap","10px"],["class","button--justify-start"],["class","tooltip"],["attr","aria-label","Download all components"],["click",()=>k({action:"DOWNLOAD_ALL"})])(r.span()("capui.zip"),r.span()("[\u2193]")),r.button(["class","button"],["class","button--light"],["class","button--outline"],["class","button--block"],["style","marginBottom","10px"],["class","button--justify-start"],["click",()=>k({action:"SET_PAGE",page:"HOME"})])("Home"),r.button(..._,["click",()=>k({action:"SET_PAGE",page:"THEME"})])("Theme"),r.button(..._,["click",()=>k({action:"SET_PAGE",page:"UTILITY"})])("Utility"),r.button(..._,["click",()=>k({action:"SET_PAGE",page:"ACCORDION"})])("Accordion"),r.button(..._)("Alerts"),r.button(..._)("Badge"),r.button(..._,["click",()=>k({action:"SET_PAGE",page:"BUTTON"})])("Button"),r.button(..._)("Card"),r.button(..._)("Dashboard"),r.button(..._)("Dialog"),r.button(..._)("Flexpane"),r.button(..._)("Grid"),r.button(..._)("Tag"))),Pe=r.div(["class","dashboard__nav-footer"])("\xA9Copyright 2024"),$e=r.div(["class","dashboard__main-header"],["innerHTML:pages",()=>"Home",()=>f.get()==="HOME"],["innerHTML:pages",()=>"Accordion",()=>f.get()==="ACCORDION"],["innerHTML:pages",te,()=>f.get()==="BUTTON"],["innerHTML:pages",te,()=>f.get()==="THEME"],["innerHTML:pages",()=>"Utility",()=>f.get()==="UTILITY"])(),Ie=r.div(["class","dashboard__main"],["innerHTML:pages",()=>"Home",()=>f.get()==="HOME"],["innerHTML:pages",()=>"Accordion",()=>f.get()==="ACCORDION"],["innerHTML:pages",fe,()=>f.get()==="BUTTON"],["innerHTML:pages",we,()=>f.get()==="THEME"],["innerHTML:pages",()=>"Utility",()=>f.get()==="UTILITY"])(),Ne=r.div(["class","dashboard__main-footer"],["class","dashboard__nav-footer"])(r.span()("All rights reserved. Made in the USA \u{1F1FA}\u{1F1F8} by ",r.a(["attr","href","https://kevinlint.com"],["attr","target","_blank"],["style","color","white"])("Kevin Lint")," as a product of ",r.a(["attr","href","https://github.com/linttrapmedia"],["attr","target","_blank"],["style","color","white"])("Lint Trap Media."))),Be=r.div(["class","dashboard__aside-header"])("Aside Header"),Re=r.aside(["class","dashboard__aside"],["innerHTML:properties",ye,()=>C.get()==="COLOR_PICKER"])(),Ue=r.aside(["class","dashboard__aside-footer"])("Aside footer");document.addEventListener("DOMContentLoaded",()=>{r.$el("#root")(["class","dashboard"],["innerHTML",()=>[Oe,De,Pe,$e,Ie,Ne,Be,Re,Ue]]),M(),X(),ae(),ne(),le(),ie(),de(),se(),X(),ce(),be(),ge(),pe(),he(),ve(),ue(),me(),document.adoptedStyleSheets=[L,O,D,P,$,I,N,B,R,U,j,G,W,V,K,J]});})();
